...
class UserServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.CreateUser = channel.unary_unary(
                '/usercard.UserService/CreateUser',
                request_serializer=user__pb2.UserRequest.SerializeToString,
                response_deserializer=user__pb2.UserResponse.FromString,
                _registered_method=True)
        self.ListUsers = channel.unary_unary(
                '/usercard.UserService/ListUsers',
...
def add_UserServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'usercard.UserService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('usercard.UserService', rpc_method_handlers)
